...
import { verifyOtp, forgotPassword } from '../../redux/slices/auth/passwordSlice'
    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="flex items-center justify-center gap-12 max-w-6xl w-full mx-auto">
        <div className="flex flex-col items-center gap-6 flex-shrink-0">
          ...
          <div className="bg-white rounded-2xl shadow-lg shadow-orange-600/20 border border-orange-600/50 p-8 w-100 py-12">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col items-center gap-5">
              ...
              <p className="text-xs text-gray-500 text-center">
                ...
                <button
                  ...
                  className={`font-semibold transition-colors ${
                    canResend ? 'text-[#E8431A] hover:underline cursor-pointer' : 'text-gray-400 cursor-not-allowed'
                  }`}
                >
                  Resend Code
                </button>
              ...
              {!canResend && (
                <p className="text-xs text-gray-500 -mt-3">00:{pad(seconds)} Sec</p>
              )}
        ...
        <div className="hidden lg:flex flex-1 items-center justify-center">
          <img src={enterOtp} alt="Enter OTP illustration" className="w-full" />
        </div>
      </div>
    </div>
  )
