  ...
  return (
    <div className="w-full h-full">
      <div className="bg-white h-full rounded-xl border border-gray-200 p-7 shadow-sm flex flex-col">
        ...
        {/* Show loader only while categories are loading (initial page load) */}
        {categoryLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                {categories.length === 0 && (
                  <p className="text-xs text-amber-500 mt-1">
                    No categories found. Check the /categories/dropdown API
                    response.
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Lettuce, Tomato, Cucumber..."
                  className="w-full px-4 py-2.5 rounded-lg border border-gray-300 bg-[#F7F8F9] text-sm outline-none focus:border-[#E23E08]"
                />
              </div>
